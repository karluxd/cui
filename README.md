...
You can read the details about messages, input options, selectables, and actions in [API endpoints and responses](#API Endpoints and responses).
...
### js/helpers.js
Contains polyfills and a last resort for catching uncatched errors. It currently shows a notification to the user and logs the error to the console. We should log these js errors with ajax as well to get notified when something goes wrong.
...
#### js/views
Handlebars templates that contains the markup for generating new elements.
